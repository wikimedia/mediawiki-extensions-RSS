...
$messages['ru'] = array(
	...
	'rss-url-is-not-whitelisted' => '«$1» не входит в «белый» список разрешённых веб-каналов. {{PLURAL:$3|только $2 является разрешённым каналом|разрешены только следующие каналы: $2}}.',
