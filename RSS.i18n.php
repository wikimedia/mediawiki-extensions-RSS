...
$messages['fa'] = array(
	...
	'rss-tracking-category' => 'صفحات با آر‌اس‌اس‌ها',
	...
	'rss-url-is-not-whitelisted' => '"$1" در فهرست سفید مجاز سرورها نیست. {{PLURAL:$3|$2 تنها سرور مجاز است|سرورهای مجاز به شرح زیر هستند: $2}}.',
	'rss-empty-whitelist' => '"$1" در فهرست سفید مجاز سرورها نیست. هیچ یوآر‌ال‌های سروری مجاز در فهرست سفید نیست.',
	'rss-deprecated-wgrssallowedfeeds-found' => 'متغیر مخالفت شدهٔ سزورهای مجاز$دبلیو‌جی‌آر‌اس‌اس، شناسایی شده‌اند. از آر اس‌اس نسخهٔ ۲.۰ این متغیر باید توسط $آر‌اس‌اس‌یو‌آر‌ال توصیف شده در فرمت صفحهٔ دستی، جایگزین شود: آر‌اس‌اس',
	'rss-feed' => "<!-- در زیر دو الگوی متناوب وجود دارد. اولی الگوی پیش‌فرض اساسی برای سرورها است-->; '''<span class='plainlinks'>[{{{link}}} {{{title}}}]</span>'''
: {{{توصیف}}}
: {{{نویسنده}}} {{{تاریخ}}}<!-- اینجا از خط جدید استفاده نکنید --><!-- دوم یک نسخهٔ بهبود یافته است که نیازمند فرمت است:عملیات تجزیه--><!-- ; '''<span class='plainlinks'>[{{{پیوند}}} {{{عنوان}}}]</span>'''{{#if: {{{توصیف|}}}|: {{{توصیف}}}}}{{#if: {{{نویسنده|}}} | {{#if: {{{تاریخ|}}} |: &mdash; {{{نویسنده}}} {{{تاریخ}}}}} | {{#if: {{{نویسنده|}}}|: &mdash; {{{نویسنده}}}}} {{#if: {{{تاریخ|}}}|:{{{تاریخ}}}}}|}} -->",
);
...
$messages['mk'] = array(
	...
	'rss-parse-error' => 'Грешка при расчленувањето на XML за RSS',
...
$messages['roa-tara'] = array(
	...
	'rss-tracking-category' => 'Pàggene cu le feed RSS',
...
$messages['ru'] = array(
	...
	'rss-url-is-not-whitelisted' => '«$1» не входит в «белый» список разрешённых веб-каналов. {{PLURAL:$3|1=Разрешён только канал «$2»|Разрешены только следующие каналы: $2}}.',
...
$messages['sk'] = array(
	...
	'rss-tracking-category' => 'Stránky s RSS kanálmi',
...
$messages['sv'] = array(
	...
	'rss-tracking-category' => 'Sidor med RSS-flöden',
