...
: {{{توصیف}}}
: {{{نویسنده}}} {{{تاریخ}}}<!-- اینجا از خط جدید استفاده نکنید --><!-- دوم یک نسخهٔ بهبود یافته است که نیازمند فرمت است:عملیات تجزیه--><!-- ; '''<span class='plainlinks'>[{{{لینک}}} {{{عنوان}}}]</span>'''{{#if: {{{توصیف|}}}|: {{{توصیف}}}}}{{#if: {{{نویسنده|}}} | {{#if: {{{تاریخ|}}} |: &mdash; {{{نویسنده}}} {{{تاریخ}}}}} | {{#if: {{{نویسنده|}}}|: &mdash; {{{نویسنده}}}}} {{#if: {{{تاریخ|}}}|:{{{تاریخ}}}}}|}} -->",
);
